...
const WORLD_SOUND_PROFILES: Record<WorldId, WorldSoundProfile> = {
  ...
  volcano: {
    ...
    selectStep: 36,
    selectType: 'sawtooth',
    foundChord: [415, 554, 698],
    completeArpeggio: [415, 494, 554, 698, 932],
    wrongFreq: 165,
    wrongType: 'square',
    spinStart: 240,
    spinEnd: 860,
  ...
  sky: {
    ...
    selectStep: 26,
    selectType: 'triangle',
    foundChord: [392, 523, 698],
    completeArpeggio: [392, 440, 523, 698, 880],
    wrongFreq: 140,
    wrongType: 'sine',
    spinStart: 210,
    spinEnd: 720,
  ...
  crystal: {
    ...
    selectStep: 38,
    selectType: 'sine',
    foundChord: [523, 698, 932],
    completeArpeggio: [523, 587, 698, 932, 1174],
    wrongFreq: 175,
    wrongType: 'triangle',
    spinStart: 270,
    spinEnd: 900,
  ...
  shadow: {
    ...
    selectStep: 30,
    selectType: 'triangle',
    foundChord: [311, 415, 523],
    completeArpeggio: [311, 349, 415, 523, 622],
    wrongFreq: 125,
    wrongType: 'sawtooth',
    spinStart: 190,
    spinEnd: 650,
  ...
  clockwork: {
    ...
    selectStep: 31,
    selectType: 'square',
    foundChord: [440, 587, 784],
    completeArpeggio: [440, 494, 587, 784, 988],
    wrongFreq: 150,
    wrongType: 'triangle',
    spinStart: 230,
    spinEnd: 820,
